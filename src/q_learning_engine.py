...
class DQNEngine:
    ...
    def build_model(self):
        model = tf.keras.Sequential([
            tf.keras.layers.Conv2D(32, (3, 3), activation='relu', input_shape=(8, 8, 19)),
    ...
    def choose_move(self, board: Board):
        ...
        print(self.state_to_input(board.save_to_FEN()))
    ...
    def state_to_input(self,fen: str):
        import chess
        """
        ...
        r = np.array([is_white_turn, *castling,
                     counter, *arrays, en_passant]).reshape((1, *(8,8,19)))
        # memory management
        del board
        return r